class Character():
    ...
    #This entire section defines the functions needed for the baseline character to work, it starts by initializing its base health, strength, hp, agility and other stats that it 
    #requires to function
    #Problems with indentation

character1 = Character("Julian")
print(character1.getUsername())
#Checks if the player's username will print